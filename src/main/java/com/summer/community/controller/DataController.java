...
//            System.out.println("");
     //   model.addAttribute("uvStartDate", start);
       // model.addAttribute("uvEndDate", end);
        result.data("uvResult", uv);
        result.data("uvStartDate", start);
        result.data("uvEndDate", end);
     //   return "forward:/data";
...
//        return "forward:/data";
        result.data("dauResult", dau);
        result.data("dauStartDate", start);
        result.data("dauEndDate", end);
        return result.toString();
    }
